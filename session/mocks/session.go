...
// Source: github.com/felippeduran/pitaya/v2/session (interfaces: Session,SessionPool)
...
func (m *MockSession) GetSubscriptions() []*nats_go.Subscription {
...
func (m *MockSession) SetSubscriptions(arg0 []*nats_go.Subscription) {
